...
ActiveRecord::Schema[8.1].define(version: 2026_04_03_061537) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.string "x_video_url"
    t.index ["streamer_id"], name: "index_posts_on_streamer_id"
  end
  ...
  add_foreign_key "posts", "streamers"
end
